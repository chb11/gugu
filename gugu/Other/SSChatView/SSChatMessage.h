...
//cell的一些设置
#define SSChatBaseCellId        @"SSChatBaseCellId"
...
#define SSChatCellTop           8           //顶部距离cell
#define SSChatCellBottom        8           //底部距离cell
...
//文本自适应限制宽度
#define SSChatTextInitWidth    120

//图片最大尺寸(正方形)
#define SSChatImageMaxSize    80

//音频的最小宽度  最大宽度   高度
#define SSChatVoiceMinWidth     80
#define SSChatVoiceMaxWidth     80
#define SSChatVoiceHeight       45
//音频时间字体
#define SSChatVoiceTimeFont     14
//音频波浪图案尺寸
#define SSChatVoiceImgSize      15


//地图位置宽度 高度
#define SSChatMapWidth        120
...
typedef NS_ENUM(NSInteger, SSChatMessageFrom) {
    SSChatMessageFromOther    = 1,
    SSChatMessageFromMe = 2,
...
typedef NS_ENUM(NSInteger, SSChatMessageType) {
    SSChatMessageTypeText =0,//文本消息
    SSChatMessageTypeMap,//定位消息（位置）
    SSChatMessageTypeImage,//图片消息
    SSChatMessageTypeVoice,//音频消息
    SSChatMessageTypeVideo,//视频消息
    SSChatMessageTypeAttachment,//文档
    SSChatMessageTypeShare,//分享
    SSChatMessageTypeActivity,//分享活动
    SSChatMessageTypeUserPosition,//活动中用户位置
    SSChatMessageTypeEditRoute,//队长更换导航
    SSChatMessageTypeShareLocation,//共享位置
    SSChatMessageTypeCard,//分享名片
};
