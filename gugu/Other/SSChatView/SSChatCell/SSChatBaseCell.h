...
@property (nonatomic,copy) void(^block_headClick)(SSChatMessagelLayout  *layout);
@property (nonatomic,copy) void(^block_messageClick)(SSChatMessagelLayout  *layout);
@property (nonatomic,copy) void(^block_messageLongAction)(SSChatMessagelLayout  *layout);
@property (nonatomic,copy) void(^block_readVoice)(SSChatMessagelLayout  *layout);
