...
-(void)setLayout:(SSChatMessagelLayout *)layout{
    ...
    if (layout.message.messageFrom == SSChatMessageFromOther) {
        _mMapView.frame = CGRectMake(14, 53, self.mBackImgButton.width-20, self.mBackImgButton.height-60);
    }else{
        _mMapView.frame = CGRectMake(8, 53, self.mBackImgButton.width-20, self.mBackImgButton.height-60);
    }
    
    [_mMapView addlayerRadius:10];
