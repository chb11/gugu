...
-(NSDictionary*)textAttributesAtPoint:(CGPoint)pt
{
    ...
    CGPathAddRect(framePath, NULL, CGRectMake(0, 0, self.frame.size.width+10, self.frame.size.height+30));
    ...
    pt.y -= (self.frame.size.height - bottom)/2+20;
    ...
    for(CFIndex i = 0; i < linesCount; ++i) {
        ...
        if(pt.y < (floor(lineOrigin.y) + floor(descent))) {
            ...
            pt.x -= lineOrigin.x+25;
            pt.y -= lineOrigin.y+10;
